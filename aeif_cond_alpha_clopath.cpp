...
nest::RecordablesMap< nest::aeif_cond_alpha_clopath > nest::aeif_cond_alpha_clopath::recordablesMap_;
...
template <>
void
RecordablesMap< aeif_cond_alpha_clopath >::create()
{
  // use standard names whereever you can for consistency!
  insert_( names::V_m, &aeif_cond_alpha_clopath::get_y_elem_< aeif_cond_alpha_clopath::State_::V_M > );
  ...
  insert_( names::u_bar_bar, &aeif_cond_alpha_clopath::get_y_elem_< aeif_cond_alpha_clopath::State_::U_BAR_BAR > );
}
}

extern "C" int
nest::aeif_cond_alpha_clopath_dynamics( double, const double y[], double f[], void* pnode )
{
  // a shorthand
  typedef nest::aeif_cond_alpha_clopath::State_ S;

  // get access to node so we can almost work as in a member function
  assert( pnode );
  const nest::aeif_cond_alpha_clopath& node = *( reinterpret_cast< nest::aeif_cond_alpha_clopath* >( pnode ) );
...
nest::aeif_cond_alpha_clopath::State_::State_( const Parameters_& p )
  : r_( 0 )
{
...
nest::aeif_cond_alpha_clopath::State_::State_( const State_& s )
  : r_( s.r_ )
{
  for ( size_t i = 0; i < STATE_VEC_SIZE; ++i )
  {
...
nest::aeif_cond_alpha_clopath::State_& nest::aeif_cond_alpha_clopath::State_::operator=( const State_& s )
{
  r_ = s.r_;
  for ( size_t i = 0; i < STATE_VEC_SIZE; ++i )
  {
...
void
nest::aeif_cond_alpha_clopath::Parameters_::get( DictionaryDatum& d ) const
{
...
void
nest::aeif_cond_alpha_clopath::Parameters_::set( const DictionaryDatum& d, Node* node )
{
  ...
  else if ( Delta_T > 0. )
  {
    ...
    if ( ( V_peak_ - V_th_rest ) / Delta_T >= max_exp_arg )
    {
      throw BadProperty(
...
void
nest::aeif_cond_alpha_clopath::State_::get( DictionaryDatum& d ) const
{
...
void
nest::aeif_cond_alpha_clopath::State_::set( const DictionaryDatum& d, const Parameters_&, Node* node )
{
...
nest::aeif_cond_alpha_clopath::Buffers_::Buffers_( aeif_cond_alpha_clopath& n )
  : logger_( n )
  , s_( 0 )
  , c_( 0 )
  , e_( 0 )
...
nest::aeif_cond_alpha_clopath::Buffers_::Buffers_( const Buffers_&, aeif_cond_alpha_clopath& n )
  : logger_( n )
  , s_( 0 )
  , c_( 0 )
  , e_( 0 )
...
nest::aeif_cond_alpha_clopath::aeif_cond_alpha_clopath()
...
nest::aeif_cond_alpha_clopath::aeif_cond_alpha_clopath( const aeif_cond_alpha_clopath& n )
...
void
nest::aeif_cond_alpha_clopath::init_buffers_()
{
  ...
  B_.sys_.function = aeif_cond_alpha_clopath_dynamics;
...
void
nest::aeif_cond_alpha_clopath::calibrate()
{
