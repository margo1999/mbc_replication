"""
This script has to be executed when the experiment 'sequence training' should be started on your local machine. Based on the
...
from experiments.parameters_space import param_readout
...
if __name__ == '__main__':
    ...
    # Parameters list
    parameter_set_list = training_helper.parameter_set_list(param_readout)
